...
- ✅ NIP-22 created_at limits: events stamped more than 15 minutes in the
  future or 3 years in the past are rejected as out of the acceptable range
...
- ✅ NIP-28 public chat: channel events (kinds 40-44) are stored and served
  generically, verified end-to-end with kind-42 channel messages
- ✅ NIP-40 expiration: events with an ["expiration", ts] tag stay stored
  but are no longer served (REQ or live broadcast) once the time has passed
